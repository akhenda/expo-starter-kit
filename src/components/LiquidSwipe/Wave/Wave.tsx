...
import { Side, WaveProps } from './Wave.types';

export const { width: WIDTH, height: HEIGHT } = metrics;
...
const Wave = ({ side, position: { x, y }, children, isTransitioning }: WaveProps) => {
      ...
      transform: [
        {
          translateX:
            ...
            isTransitioning.value ? withTiming(0) : side === Side.RIGHT ? WIDTH - ledge.value : -WIDTH + ledge.value,
        },
      ],
    };
  });
